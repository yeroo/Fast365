...
This document is the published code-signing policy for **Fast365**.
...
```
Get-FileHash .\Fast365-windows-x86_64.exe -Algorithm SHA256
# compare against Fast365-windows-x86_64.exe.sha256
```

Provenance (GitHub CLI):

```
gh attestation verify Fast365-windows-x86_64.exe --repo yeroo/Fast365
```
...
Fast365 is a local command-line tool. It performs no network access and
